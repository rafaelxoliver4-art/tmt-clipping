...
# Source: Obsidian wiki vault (NEWS_WRITER_CONTEXT.md, latam-tmt-coverage-universe.md, — auto-updated 2026-05-11 — auto-updated 2026-05-14 — auto-updated 2026-05-19 — auto-updated 2026-05-21
...
- **TEO/Telefónica Argentina antitrust review** — 30-day pronouncement window (track Enacom/Competencia statements); conditional remedies possible; affects post-deal MSR and 5G capex. Promote to a full note when the regulator pronounces or when concrete remedies leak.
...
- **NuCel (Nubank MVNO on Claro's network)** — 4× QoQ active subs in 4Q25 (~232k est.). Positive AMX driver, drags TIM prepaid more than TEF-BZ. TIM CEO on Q4 call: "Nucel is not material at this stage"; back-book price increases communicated Dec-25 expected to drive Q1 churn.
...
- Brazil smartphone/electronics import-tariff debates can be tagged `INTB/POSI/MLAS:` when the angle hits all three; surface as Hardware sector items unless one name is explicitly affected.
...
- When Rafael flags an unclear or awkward word ("emarbgos? strange wording"), rewrite the entire sentence cleanly in plain English rather than just substituting the word; preserve attribution and dates exactly.
...
- **Quarterly ESG TMT recap** — co-authored with Andre Salles. Telecom + Technology split, two themes per sector, COP / CDP / S&P CSA scores, data-center and renewable-energy deployments. Recurring data points to surface: TEF-BZ at CDP A List, Vivo S&P Global CSA score, TIM Brasil CDP A List, GLOB Integrated Report (GHG reduction YoY, CDP Supplier Engagement score).
