...
not scraped? capped out before the curator? curator didn't select? auth/parse failure?
Then fix and note it in `CLAUDE.md`.

> Process going forward (per analyst request 2026-06-24): every clipping should be
> cross-checked against this benchmark; investigate misses, improve continuously.
...
**Telecom LatAm and World**
- TV: BlackRock reports 5.2% ownership of Grupo Televisa common stock
- TV: Televisa pide perfeccionar la subasta 5G industrial de CRT para atajar barreras financieras y asignaciones desfavorables
- TV: Izzi apuesta por Starlink ante el avance del internet satelital directo a celulares
- AMX: Registro de líneas celulares en México ya suma 68 millones; Sheinbaum niega control gubernamental
- AMX: Claro supera 3 millones de usuarios 5G entre Costa Rica y Ecuador
- TIGO/AMX: Altos custos do solo freiam a implantação de infraestrutura móvel no Chile
- Sector: AT&T paga 23.000 mdd por licencias de espectro de EchoStar

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Starlink se aproxima de 10% da banda larga rural no país, aponta Ookla
- AMX/TEF-BZ/TIM: Starlink tem recuo na velocidade de download no Brasil, aponta Ookla
- AMX/TEF-BZ/TIM: Operadoras brasileiras entre líderes globais de internet fixa e móvel
- TIM/BRISANET: TIM e Brisanet recebem licenças de espectro em caráter secundário
- TIM: TIM vai inaugurar 80 lojas físicas em 2026
- V.tal: V.tal e Meta iniciam ancoragem do cabo Malbec no RS
- Sector: Brasil consultará sobre uso de banda de 6 GHz para WiFi em exteriores
- Sector: Investimentos estrangeiros em telecomunicações batem recorde

**IT Services**
- GLOB/CINT: Forward-deployed engineers are the AI industry's latest talent obsession
- Sector: Capgemini sees multi-year IT modernisation boom as firms prepare for AI
- Sector: As token costs mount, leaders revise their AI plans

**Software and AI**
- TOTVS: How AI Is transforming SaaS pricing and shifting enterprise spending to labor budgets
- TOTVS: Oracle to Make Gemini Models Available to Thousands of Enterprise Applications Customers
- OpenAI: OpenAI cuts prices for two of its GPT-5.6 AI models as companies grow sensitive to costs
- Sector: Microsoft is openly competing with OpenAI, Anthropic more than ever
- Sector: Em seis meses, agentes autônomos do banco BV elevaram taxa de recuperação de crédito a 48%

## Clipping 2026-07-30

**Telecom LatAm and World**
- TIGO: Honduras lanza subasta de espectro AWS para 4G y 5G
- TIGO: Chile | El duro revés de Movistar ante la justicia: deberá pagar deuda de $3.746 millones con el Fisco en medio de su conversión a Tigo
- TEO: Starlink y Enacom llevarán internet satelital a 6.000 escuelas argentinas
- AMX: México | México retrocede en espectro radioeléctrico por costos elevados: AT&T
- Sector: American Tower sees Brazil recovery, Latin America growth returning in 2027
- Sector: IA elevará la demanda de redes y centros de datos

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Guerra de preços na telefonia: como Vivo, Claro e TIM se preparam para cenário de maior competição
- AMX/TEF-BZ/TIM: Na zona rural, Starlink já tem mais clientes de internet que Claro e Vivo
- AMX/TEF-BZ/TIM: Starlink se aproxima de 10% da banda larga rural no país, aponta Ookla
- AMX/TEF-BZ/TIM: São Paulo é primeiro estado a atualizar lei de antenas em todos os municípios
- AMX: Brasil | Claro Empresas lança plataforma com IA da Microsoft para automatizar resposta a incidentes
- TIM/TEF-BZ: Ibovespa hoje sobe com IPCA-15 abaixo do esperado; TIM e Telefônica Brasil tombam após balanços — Estadão
- TEF-BZ: Telefônica Brasil, dona da Vivo, procura parceiros para compartilhar torres e reduzir custos com infraestrutura

**IT Services**
- GLOB/CINT: Capgemini upgrades its 2026 outlook
- GLOB/CINT: Capgemini lifts 2026 revenue growth target on AI transformation demand — The Economic Times
- GLOB/CINT: Blog: Accenture Tokenomics Launched to Help Enterprises Manage AI Token Spend
- Sector: Cognizant forecasts weak quarterly revenue amid cautious client spending — The Economic Times
- Sector: Grid Dynamics Accelerates Enterprise AI-Native Transformation With Workforce Certification and GAIN Platforms Rollout
- Sector: Cognizant lifts annual profit forecast on strong financial services growth
- Sector/BZ: Cresce número de formados em TI, mas ainda há escassez de mão de obra

**Software and AI**
- TOTVS: Plataformas low-code barateiam e aceleram a criação de softwares
- TOTVS: Reforma Tributária: quase metade das PMEs não se preparou para transição de setembro
- TOTVS: B3 e TOTVS abrem inscrições para programas de estágio em tecnologia
- OPENAI: OpenAI, Anthropic, and Cursor all localized pricing for India. Only two focused on value
- Sector: Tivit espera expansão de dois dígitos no Brasil com impulso de serviços digitais
- Sector: Oracle simplifies migrating legacy databases off IBM mainframes with support for EBCDIC
- Sector: Snowflake launches AI agent governance layer to track activity, control costs

**Ecommerce**
- VTEX: VTEX aposta para digitalizar vendas B2B e crescer além do varejo online
- VTEX/LWSA: IPO da Shein vem aí: como abertura de capital pode afetar ações de varejistas na B3?
- Sector: Shopee aumenta em mais de 60% o número de Centros de Distribuição no Brasil em 2026
- Sector: Agentic commerce exige arquitetura híbrida e controle de custos para evoluir, diz NVIDIA
- Sector: E-commerce brasileiro fatura R$ 208,4 bilhões no primeiro semestre
- Sector: Cielo agora tem pagamento por agentes da IA

## Clipping 2026-07-29

**Telecom LatAm and World**
- AMX: América Móvil usará agentes de IA para controlar gastos y conocer mejor a sus clientes
- Sector: Chile impulsará la conectividad satelital D2C con nuevas bandas y mayor competencia — Mobile Time Latinoamérica
- Sector: Altos costos del suelo frenan el despliegue de infraestructura móvil en Chile
- Sector: Compartir infraestructura no basta: American Tower pide nuevo modelo de colaboración

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Brasileiro migra de operadora no pré-pago no 2º tri, mostram balanços de Vivo e TIM — Bloomberg Línea Brasil
- TEF: Telefónica eleva projeção de caixa e volta a ter lucro no 2º trimestre
- TIM/TEF-BZ: TIM e Vivo minimizam interesse na Oi Soluções
- TIM: TIM Brasil não está à venda e é considerada uma 'joia' por novo controlador na Itália, diz CEO
- TIM: Mercado teme que teles abandonem postura racional em favor da competitividade, diz CEO da TIM Brasil
- TIM: TIM moderniza rede em Salvador e planeja cinco novas capitais em 2026
- TIM: TIM fará aporte de capital de até R$ 670 milhões na I-Systems e V8.Tech
- TEF-BZ: Vivo vê mercado mais competitivo com entrada das móveis regionais
- TEF-BZ: Vivo será one stop shop de serviços de IA — Mobile Time
- TEF-BZ: Vivo quer desligar redes 2G, 3G e 4G o "quanto antes"
- TEF-BZ: Vivo terá agentes de IA atendendo chamadas no call center

**IT Services**
- GLOB/CINT: Top 5 IT services companies see 3.3% staff productivity boost in Q1; Wipro the only laggard as TCS, Infosys
- GLOB/CINT: AI costs heat forcing vendors to rethink pricing, Pegasystems executive
- Sector: Coforge shares surge 7% after Q1 profit spikes 63% YoY

**Software and AI**
- TOTVS: Earnings from SAP, ServiceNow, and IBM challenge the SaaSpocalypse narrative
- TOTVS: Itaú reduziu em 65% seus gastos com IA generativa, revela diretor
- Sector: Microsoft launches its first cybersecurity model, plus a new agentic cybersecurity system
- Sector: Amazon winds down most flagship AI models in strategy overhaul, Business Insider reports
- Sector: Anthropic's Dario Amodei responds: doesn't oppose open-weight models, but fears Chinese AI

**Ecommerce**
- LWSA: Bling quer ir além do ERP e ser one stop shop para PMEs
- LWSA: Wake lança Córtex, orquestrador de agentes de IA no varejo
- LWSA: Como criar uma loja virtual na Tray em minutos

**Streaming**
- TV: Incoming Apple CEO aims to build on movie and TV progress

**Hardware**
- Sector: Apple launches 'Upgrade' device leasing program in partnership with Klarna

## Clipping 2026-07-28

**Telecom LatAm and World**
- AMX: CRT: Conectividad móvil durante el Mundial 2026 mejoró con el espectro temporal
- TIGO: El duro revés de Movistar ante la justicia: deberá pagar deuda de $3.746 millones con el Fisco en medio de su conversión a Tigo Chile
- TIGO: Honduras | Conatel informa sobre concurso de espectro de banda 1700/2100
- TEO: Arrancó el proceso de desinversión de Telecom con la designación de una figura clave
- Sector: Amazon planeja constelação de até 5.105 satélites para serviços de telefonia e dados
- Sector: Antel Uruguay invertirá más de 750 millones de dólares hacia 2030
- Sector: Chile impulsará la conectividad satelital D2C con nuevas bandas y mayor competencia

**Telecom Brazil**
- TEF-BZ: Telefônica Brasil quer se consolidar como varejista no segmento de eletrônicos, diz comando
- TEF-BZ: Vivo pretende acelerar venda de cabos de cobre e imóveis
- TIM: TIM fará aporte de capital de até R$ 670 milhões na I-Systems e V8.Tech
- AMX/TEF-BZ/TIM: Tráfego dispara, mas redes sustentam transmissão da Copa na Internet
- BRISANET: Brisanet levará 5G a 62 cidades de Goiás

**IT Services**
- GLOB/CINT/TOTVS: Gartner Survey Finds AI Automation Is Reducing Some Entry Level Hiring at Nearly One-Quarter of Organizations
- GLOB/CINT: TCS, Infosys, Coforge, other IT stocks rally up to 10% after Nvidia-led chip rout. Is AI trade ending?
- Sector: Cognizant and Anthropic expand partnership to embed Claude in Cognizant's industry platforms, helping clients close the gap between AI promise and business outcomes

**Software and AI**
- TOTVS: Senior anuncia o primeiro ERP da América Latina operável por ChatGPT e Claude
- TOTVS: TOTVS acelera su crecimiento en México con inversión de más de 118 millones de dólares *(analyst note: source never seen before — worth asking them)*
- TOTVS: SAP: Soluções em nuvem e IA impulsionam resultados da SAP na América Latina

**Ecommerce**
- VTEX/LWSA: Em meio a tarifaço dos EUA, Fiemg defende retomada da taxa das 'blusinhas'

**Hardware**
- INTB: Verisure investe R$ 1 bi por ano em nova geração de alarmes com videomonitoramento

## Clipping 2026-07-27

**Telecom LatAm and World**
- AMX: Revolut lanza eSIM de viaje en su app para clientes en México
- AMX: Claro tv+ cresce em audiência durante a Copa do Mundo de 2026
- TV: Televisa vuelve a la banda de los 600 MHz para probar un 5G Broadcast en Ecatepec
- TV: México ocupa el tercer lugar mundial en rendimiento de streaming móvil
- TIGO: Tigo Business, el negocio B2B de Millicom con el que Xavier Niel se presentará en sociedad en Chile
- TEO: Enacom Argentina modifica el valor de referencia de la Unidad de Tasación Radioeléctrica
- Sector: FCC aprueba nueva subasta de espectro en banda C para 2027

**Telecom Brazil**
- TIM: TIM-backed VC fund invests in Brazilian legal AI unicorn
- TEF-BZ: Clientes da Vivo poderão acessar Starlink pelo celular em breve
- TIM/TEF-BZ: Ações da Telefônica (VIVT3), dona da Vivo, e da TIM (TIMS3) 'driblam' aversão a risco local à espera de balanço do 2T26 — Money Times

**IT Services**
- GLOB/CINT: IT firms Q1 growth not enough to offset AI's impact on traditional biz
- GLOB/CINT: IT price wars squeeze Infosys out of three multi-million dollar accounts — The Economic Times
- TOTVS/GLOB/CINT: Enterprises contend with mounting AI costs as tools sprawl — CIO Dive
- Sector: GCCs now influence up to $55 billion of India's IT services exports — Deloitte

**Software and AI**
- TOTVS: TIVIT cresce 45% em cibersegurança com novo SOC
- Sector: 86% do uso de IA conversacional é doméstico, aponta estudo do Google
- Sector: Anthropic launches Opus 5
- Sector: CEO da Nvidia defende modelos chineses de inteligência artificial

**Ecommerce**
- VTEX/LWSA: Facebook launches a dedicated Marketplace app for sellers, adds a free verification system
- Sector: Vendas online no Brasil crescem 9% em 2025 e movimentam US$ 3,8 bi na América Latina

**Hardware**
- Sector: Abinee cobra novas medidas após EUA elevarem sobretaxa a 37,5% *(analyst note: possible read-across for Intelbras)*

## Clipping 2026-07-24

**Telecom LatAm and World**
- AMX: Bait tiene menos usuarios nuevos pero genera 3,800 mdp para Walmart; logra ser rentable a pesar del registro — expansion.mx
- TIGO: Panamá | Tigo invertirá hasta $6 millones en espectro 5G — DPL News
- TV: México ocupa el tercer lugar mundial en rendimiento de streaming móvil
- Sector: Telxius activa Punto de Presencia en República Dominicana

**Telecom Brazil**
- TEF: Digital Metrics | Caída de ingresos de Movistar redunda en baja de facturación minorista telco en España
- V.tal: Nio compra a carteira de clientes da Onitel
- Sector: Para Telcomp, especificidades do setor de telecom exigem atenção redobrada na implementação das novas regras tributárias
- Sector: Anatel aprova fim da concessão de telefonia fixa da Sercomtel — TELETIME News

**IT Services**
- GLOB/CINT: India's IT giants grapple with weak growth despite resilient deal momentum — The Economic Times
- Sector: As US AI costs soar, global businesses pivot to China's low-cost, open-weight models — The Star
- ACN: Accenture eyes $350 million majority stake in ANSR at $1 billion valuation

**Software and AI**
- TOTVS: SAP trims 2026 profit goal, signalling cost of AI push — The Economic Times
- TOTVS: OpenAI Presence raises new questions about enterprise automation and jobs
- TOTVS: Adoção de nuvem cresce 77% e amplia integração com ERP — Valor Econômico
- BZ: IA já está em 59% dos órgãos públicos e em 94% do Judiciário
- Sector: Google's Gemini nears billion-user milestone
- Sector: Smaller, smarter, safer: How to build agentic AI on the right foundation
- Sector: Anthropic updates Claude voice mode with more capable models
- Sector: Fluxo de caixa livre negativo do Google alimenta temores sobre gastos com IA

**Ecommerce**
- LWSA: Na era das buscas por IA, Tray leva "mapa de ação" e cases de sucesso ao Fórum E-Commerce Brasil 2026
- MELI: Shopee e Mercado Livre travam corrida que já afeta o mercado de galpões — Economic News Brasil

**Hardware**
- POSI: Positivo Servers & Solutions lança solução integrada para adoção de IA on-premises nas empresas brasileiras — Data Center Dynamics
...
**Telecom LatAm and World**
- AMX: América Móvil anticipa compras de smartphones para Telcel ante riesgo de una nueva escasez de chips por el auge de la IA
- AMX: Registro de líneas móviles en México: Avanza 43 por ciento vinculación obligatoria
- AMX: CRT amplía 184 días el plazo para vincular líneas celulares con la CURP; 43% de usuarios ya se registró
- TEO: Qué mercado telecom espera a un posible nuevo competidor en Argentina
- CO: MinTIC finaliza el corte 5 de asignación de espectro radioeléctrico

**Telecom Brazil**
- BRISANET: Brisanet terá 5G em 115 cidades de Goiás e Mato Grosso do Sul em 2026
- Sector: Governo lança rede de comunicação privativa para órgãos federais com investimento de R$ 1 bilhão
- Sector: Custos de componentes dão trégua, mas seguem elevados, diz Abinee

**IT Services**
- GLOB/CINT: AI coding costs will surpass average developer's salary by 2028 as token consumption surges: Gartner
- Sector: AI coding token costs are on track to rival human payroll

**Software and AI**
- TOTVS: Salesforce unveils AI Help Agent with pay-per-resolution pricing
- TOTVS: Senior escala desenvolvimento de agentes com Oracle
- TOTVS: HPE Automotores substitui ERP global por TOTVS
- TOTVS: Quase 60% das PMEs consideram que IA tem como principal benefício a produtividade, diz Serasa
- Anthropic: Anthropic's Claude is winning over paid consumers, a market owned by ChatGPT
- Sector: Chinese AI models up to 50 times cheaper as enterprises reassess OpenAI, Anthropic costs: JPMorgan

**Ecommerce**
- LWSA: Appmax e Wake lançam integração focada em aprovação e performance de pagamentos

## Clipping 2026-06-25

**Telecom LatAm and World**
- LatAm telcos: En 2029, la IA triplicará el tráfico de las redes corporativas: Cisco
- AMX: El registro telefónico tiene un rezago de casi 70% en zonas rurales
- AMX: Telecomm se convirtió en el "jugador 13" del Mundial 2026 y exhibió el valor del espectro: Asiet
- AMX: Con 93% a favor en Telmex avalan revisión contractual en el Sindicato de Telefonistas
- AMX: OMV en México piden prórroga para registro móvil
- Sector: FCC arrecada mais de US$ 3,5 bilhões em retomada dos leilões de espectro nos EUA
- Sector: Da automação à autonomia: a evolução das redes móveis
- Sector: Nokia y AWS aceleran la llegada de redes autónomas y nativas de IA
- Sector: El precio promedio de los smartphones alcanzará un récord de 565 dólares en 2026, según Omdia

**Telecom Brazil**
- TIM: Anatel aprova mudança no controle indireto da TIM, I-Systems e Sparkle
- AMX/TEF-BZ/TIM: Sindicatos querem regulamentar profissão de teleoperador; empresas alertam para impacto sobre empregos
- Sector: Starlink questiona Anatel sobre nova divisão de espectro na banda S
- Sector: Anatel e marketplaces firmam compromisso para eliminar venda de minicelulares irregulares
- Sector: STF invalida normas para antenas no Maranhão, Foz do Iguaçu e Petrolina

**IT Services**
- Software/IT Services: Data lakehouses are becoming foundations for enterprise AI
- Sector: AI coding token costs are on track to rival human payroll

**Software and AI**
- TOTVS/GLOB/CINT: Companies are scrambling to stop employees from maxing out AI budgets with small tasks
- TOTVS: How Token Economics Will Change Opex
- Sector: Salesforce lança Agentic Advisor, consultor de IA autônomo para o setor financeiro
- Sector: The running list: major tech layoffs in 2026 where employers cited AI

**Ecommerce**
- Sector: Amazon lança marca própria no Brasil com entrega rápida para assinantes Prime

**Hardware**
- POSI: Positivo usa Manaus para entrar na disputa pelos AI PCs no Brasil

## Clipping 2026-06-24

**UBS Reports** *(manual-only)*
- Cerebras Systems OpenAI On Track, Customer Base Expanding
- US Semiconductors Revisiting AMD and ARM Estimates Amid Agentic AI Acceleration
- Capgemini H1 26 results preview
- THE SAGE GROUP PLC Q3 26 results preview

**Macro** *(manual-only)*
- World: Top Three Macro Risks at the Moment

**Telecom LatAm and World**
- AMX: AT&T alcanza 9 millones de líneas registradas ante el "apagón" telefónico de la CRT
- AMX: A ocho días del cierre, 83 millones de líneas celulares siguen sin registrarse; ¿habrá prórroga de CRT?
- AMX: Usuarios prepago de Claro Ecuador ya tienen acceso a roaming
- AMX: México | Las cabinas de teléfono que nadie usa, pero Telmex no puede retirar
- AMX: Ventas de smartphones en México caerán 12% por crisis de la RAM
- Sector: Fabricantes de smartphones devem priorizar produção de aparelhos premium

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Anatel quer manter incentivo à competição em próximos leilões
- Sector: STF invalida leis estaduais e municipais que exigiam licença ambiental de antenas de telefonia
- Sector: Ericsson vê Brasil pronto para acelerar o 5G Standalone, mas desafio passa a ser monetização
- Sector: Abradee reage a mudanças no PL dos Postes e diz que conta de luz pode subir R$ 2 bilhões por ano
- Sector: Vendas de smartphones caem 3% no primeiro trimestre, aponta pesquisa da NielsenIQ

**IT Services**
- INFY: Infosys sees $300-400 billion AI opportunity by 2030 - The Times of India
- Sector: AI will amplify IT services demand, not replace it: Infosys chairman Nandan Nilekani

**Software and AI**
- TOTVS: WhatsApp planeja cobrar por respostas de empresas
- TOTVS: GC Aesthetic adota solução da Totvs
- TOTVS: TOTVS Linx debate tendências para o mercado de franquias - Portal ABC do ABC
- Anthropic: Anthropic's Claude Tag is learning your company, one Slack message at a time
- Anthropic: Anthropic launches Claude Tag in Slack with plans for wider rollout
- Sector: How AI Customers Are Lowering Their Anthropic and OpenAI Bills
- Sector: Oracle corta 21 mil empregos em reestruturação voltada para IA

**Ecommerce**
- MELI: Mercado Ads expande atuação com presença no TikTok, rede de criadores e vídeos "shoppable"
- VTEX/LWSA: Shopee chega ao ChatGPT

## Clipping 2026-06-23

**Macro** *(manual-only)*
- US: Strip Out AI and Energy, and the S&P 500 Is Down
- BZ: Mercado eleva projeção de inflação e vê Selic em 14% ao ano em 2026

**Telecom LatAm and World**
- TIGO/AMX: Colombia pone límites a los cobros por reconexión de servicios de telecomunicaciones
- TIGO/AMX: Guatemala | Bloque pide declarar lesiva adjudicación de frecuencia 5G
- TIGO/AMX: Colombia | Nuevas zonas de Wifi público en Medellín: estos son los nueve lugares donde ya hay internet gratuito
- AMX: La verdadera razón por la que Telmex y Carlos Slim no pueden retirar las casetas telefónicas - expansion.mx
- AMX: Ingresos telecom en Perú crecen levemente en 2025, Claro tiene un tercio del mercado
- AMX: Claro Colombia anuncia beneficios para clientes prepago en alianza con Win Sports
- Sector: «Direct to Cell nos obligó a desarrollar soluciones sobre la marcha», Entel revela los retos del despliegue en Chile y Perú

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Leilão da Oi Soluções pode ter nova rodada com desconto de 50%
- AMX/TEF-BZ/TIM/Brisa: Brisanet leva metade das localidades em leilão para antecipar metas do 5G
- TEF-BZ: Vivo abre mais de 500 vagas de estágio em 11 estados e no DF

**IT Services**
- Sector: Agentic AI adoption drives stronger governance oversight, risk controls

**Software and AI**
- TOTVS: Impacto de IA em emprego e salários nos EUA tem sido moderado, aponta BCE

**Ecommerce**
- LWSA/VTEX: Nuvemshop mira R$ 20 bilhões em vendas de parceiros e mantém IPO no radar
- VTEX: YouTube Shopping llega a México y convierte a sus creadores en vendedores
- Sector: Copa pode movimentar R$ 61 bi e levar quase 100 milhões de brasileiros às compras
- Sector: Mercado de beleza premium cresce 10% no Brasil impulsionado por e-commerce

**Streaming**
- TV/TU: Instagram looks to take on streaming services with longer-form, episodic and live formats for its TV app *(analyst note: negative read for TU if real, but rumours only — a giant entering the market, and Instagram already has instant video translation incl. Spanish)*

**Hardware**
- Sector: Governo promete supercomputador de IA no Brasil
...
- TIGO/AMX: Colombia pone límites a los cobros por reconexión de servicios de telecomunicaciones
- TIGO/AMX: Guatemala | Bloque pide declarar lesiva adjudicación de frecuencia 5G
- TIGO/AMX: Colombia | Nuevas zonas de WiFi público en Medellín
- AMX: La verdadera razón por la que Telmex y Carlos Slim no pueden retirar las casetas telefónicas — expansion.mx
- AMX: Ingresos telecom en Perú crecen levemente en 2025; Claro tiene un tercio del mercado
- AMX: Claro Colombia anuncia beneficios para clientes prepago en alianza con Win Sports
- Sector: «Direct to Cell nos obligó a desarrollar soluciones sobre la marcha», Entel (Chile/Perú)
...
**Streaming**
- TV/TU: Instagram looks to take on streaming services with longer-form, episodic and live formats for its TV app (rumour; potential giant entrant, Insta already has instant video translation incl. Spanish)
...
**Telecom LatAm and World**
- TEO: Telecom Argentina debe encontrar compradores de los activos que debe ceder para absorber a Telefónica
- AMX: CRT propone 240 lotes de espectro para 60 polos y excluye a Telcel y AT&T de la subasta 5G industrial
- AMX: Ya hay fecha para la primera licitación de espectro de la CRT de México
- TV: Televisa quiere convertirse en el gigante de las telecomunicaciones; obtiene 6,917 mdp con el ojo puesto en AT&T — expansion.mx
- TV: TV Azteca supera a Televisa en audiencia mundialista
- MX: Movistar conecta a sus clientes con cobertura en 187 países

**Telecom Brazil**
- AMX/TEF-BZ/TIM: NuCel, do Nubank, chega a 1 milhão de clientes
- AMX/TEF-BZ/TIM: Sete operadoras fazem lances para antecipar metas do 5G
- AMX/TEF-BZ/TIM: Após disputa com Claro, Anatel revela acessos das MVNOs credenciadas no Brasil
- Sector: Anatel conclui revisão da telefonia fixa em São Paulo e reestruturação dos DDDs
- Sector: Alares compra Oquei Telecom por R$ 189 milhões e expande base em SP — TELETIME News

**IT Services**
- Sector: Data centres, AI infra become IT's next growth bet
- Sector: TCS, Infosys, Wipro, other IT stocks crash up to 8% as Accenture lowers FY26 guidance
- Sector: IA agêntica acelera adoção de serviços gerenciados, aponta KPMG

**Software and AI**
- TOTVS: TOTVS redefine o uso da inteligência artificial nos negócios, foco no resultado
- TOTVS: TOTVS fecha parceria com CNC, Senac e Sesc para impulsionar empregabilidade no Brasil
- OpenAI: OpenAI is bringing on some big guns in the lead-up to its IPO
- Sector: IA pode ameaçar escritórios de advocacia e contabilidade
- Sector: Apple abre ecossistema móvel no Brasil após acordo com Cade

**Ecommerce**
- Sector: Varejo sai do encantamento com IA e cobra resultado na operação
- Sector: Copa do Mundo desloca consumo para o online e pressiona lojas físicas, aponta ICVA

**Hardware**
- Sector: Amazon hopes to challenge Nvidia more directly by selling its AI chips
...
**Telecom LatAm and World**
- TEO: Telecom-Movistar: what the regulatory setback means for the US$1.25bn deal
- AMX: Ingresos por servicios móviles en México crecen 7.2% durante el 1T 2026
- AMX: México, EE.UU. y Canadá definirán el 1 de julio futuro del T-MEC
- AMX: Clientes abandonan Telmex por altos costos y mal servicio — Pausa MX
- Sector: Latin America's 5G attracts investment, but remains far from widespread
- Sector: IA para las redes y las redes para IA: HPE apuesta por la IA nativa
- Sector: 5G responde por metade de todo o tráfego móvel global, diz Ericsson

**Telecom Brazil**
- TEF-BZ: Vivo faz parceria com Google para incluir Gemini gratuito em planos
- TIM: TIM recebe uso secundário de 2.5 GHz em 64 cidades de São Paulo
- TIM/TEF-BZ: Associação NEO contesta pedido de TIM e Vivo para alterar acordo de RAN Sharing
- Sector: Alares compra Oquei Telecom por R$ 189 milhões — TELETIME News
- Sector: Anatel abre consulta para modernizar selo de homologação — TELETIME News

**IT Services**
- COG: Cognizant expands cross-platform agentic AI with new ServiceNow AI Agent interoperability
- Sector: AI already does 37% of entry-level work in India, Cognizant-Pearson study finds
- Sector: Apenas 8% das empresas conseguem escalar uso de IA, diz relatório da Ericsson

**Software and AI**
- TOTVS: TOTVS vai levar sistema de gestão às salas de aula da CNC, Sesc e SENAI
- TOTVS: OpenAI introduces enhanced usage analytics, AI spending controls for ChatGPT Enterprise
- TOTVS: SAP: Cliente na nuvem é maioria da SAP no Brasil
- MSFT: Google and Microsoft Team Up to Beat Back Anthropic and OpenAI — The Information

**Ecommerce**
- VTEX: VTEX e WhatsApp expandem parceria com nova integração — Central do Varejo

**Hardware**
- Sector: Setor de data centers faz apelo aos estados por redução de ICMS
- INTB/POSI: Corrida por chips de IA pressiona eletrônicos e já força até a Apple a rever preços
- INTB/POSI: AI is hurting Apple in more ways than one: it may force iPhone price increases

## Clipping 2026-06-18

**Telecom LatAm and World**
- AMX: CRT exige 86 millones de dólares a AT&T para conservar espectro clave en CDMX hasta el 2047
- AMX: Operadores en México podrán vincular líneas pospago al registro móvil sin pedir datos nuevamente
- LILA: Liberty Latin America lleva 5G a Jamaica cubriendo a 70% de la población
- Sector: Latin America's 5G attracts investment, but remains far from widespread
- Sector: Verizon mira clientes de telefonia móvel com planos mais simples e elimina tarifas

**Telecom Brazil**
- AMX/TEF-BZ/TIM: Oi Soluções não recebe propostas em leilão judicial
- TIM: Governo de Minas, MPMG e TIM encerram disputas judiciais com acordo
- TIM: TIM elege Luciene Pandolfo como nova diretora jurídica
- TEF-BZ: Conselho da Telefônica aprova proposta de incorporação da FiBrasil
- Sector: RNP avalia tornar-se operadora móvel virtual
- Sector: Cidades inteligentes exigem mais que conectividade, avaliam líderes do setor
- Sector: Senado aprova projeto que blinda orçamento das agências reguladoras
- Sector: Câmara aprova urgência para o Fust; votações, inclusive do PL dos postes, ainda não têm data
- Sector: RCP do governo atenderá a 500 mil usuários se expandida nacionalmente, estima EAF
- Sector: RCPs 5G ajudarão a automatizar a indústria nacional, diz Senai

**IT Services**
- GLOB: Globant Launches Synthetic Operator, dedicated AI Pods for Live-Stream Monitoring
- Sector/BZ: Formação em TI ajuda a aumentar salário de mulheres em 33%
- Wipro: Wipro to train 10,000 experts on Anthropic's Claude models, announces Applied AI Center of Excellence

**Software and AI**
- TOTVS/GLOB/CINT: Anthropic pauses token-based pricing for Claude Agent SDK amid concerns over AI usage costs
- TOTVS/GLOB/CINT: Microsoft expands Copilot Cowork with pay-as-you-go pricing, explores cheaper AI models
- ANTHROPIC: Claude amplia atuação no Brasil com parceiros especializados

**Ecommerce**
- VTEX/LWSA: Ultrapassando R$ 75 bi em investimento, Amazon vê Brasil como marketplace
- Sector: Personalização e integração de canais ganham protagonismo no varejo

**Hardware**
- Sector: Custo determinará quanto data center avançará no país
- Sector: Google bets on Gemini to reinvent the smart home speaker

## Clipping 2026-06-17

**Telecom LatAm and World**
- AMX: Revisión del T-MEC apunta a pactos bilaterales entre México y Estados Unidos: Moody's
- AMX/TIGO: Digital Metrics | 4% de la base móvil es 5G en Ecuador

**Telecom Brazil**
- AMX/TEF-BZ/TIM: IA: Nokia aposta que operadoras passarão da economia de bits para a economia de tokens
- AMX/TEF-BZ/TIM/ISPs: Câmara aprova urgência para o Fust; votações, inclusive do PL dos postes, ainda não têm data
- TEF-BZ: Vivo investirá R$ 192 milhões para instalar 411 sites móveis no Paraná
- Brisa/Sector: Anatel: empresas precisam levar a sério exigências de regularidade fiscal e trabalhista
- Sector: Sateliot e CPQD validam IoT por satélite em área remota no Brasil
- Sector: Nokia quer GPUs em estações de telefonia móvel a partir de 2027

**IT Services**
- GLOB/CINT: Brasil concentra 38% do mercado latino-americano de TI
- Sector: Indian staffing cos step up global reach to diversify revenues

**Software and AI**
- TOTVS: Abes: sete em dez empresas miram a adoção da IA e agentes em até um ano no Brasil
- Sector: Software Hit by Double Whammy
- Sector: SpaceX to acquire Cursor for $60B in stock, days after blockbuster IPO
- Sector: AT&T Throttles Some Employees' AI Usage as 'Tokenminimizing' Arrives

**Ecommerce**
- VTEX/LWSA: ICVA: em maio de 2026, Varejo tem a maior retração desde a pandemia
- VTEX/LWSA: "Taxa das blusinhas" vai voltar para deixar suas compras mais caras; veja quanto
- VTEX/LWSA: A era do agentic commerce: se a IA não recomendar, a venda pode não acontecer

**Hardware**
- Sector: Android 17 launches with new multitasking tools as Google expands Gemini features
