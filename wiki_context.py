...
# Source: Obsidian wiki vault (NEWS_WRITER_CONTEXT.md, latam-tmt-coverage-universe.md, — auto-updated 2026-05-11 — auto-updated 2026-05-14 — auto-updated 2026-05-19 — auto-updated 2026-05-21 — auto-updated 2026-05-22 — auto-updated 2026-05-25 — auto-updated 2026-05-28
...
**US / global peers tagged for read-across (never lead the clipping, only support):** ACN (Accenture), COG (Cognizant), INFY (Infosys), TCS (Tata Consultancy), EPAM, IBM, MSFT, AMZN, SAP, Oracle, ServiceNow, Sage, Salesforce (CRM), Shopify, MELI (MercadoLibre), OpenAI, Anthropic, Nvidia, Google Cloud.
...
- **Hyperscaler / enterprise coding-agent cost surge** — Microsoft, Uber and other enterprise AI-tool customers disclosing unexpected token bills (per B note "Microsoft and Uber reportedly hit by unexpected coding-agent cost surge in 2026"; per E 27-Apr "GLOB/CINT: Uber CTO says AI spending plans fall short as tools like Claude Code drive costs up"). Tag `TOTVS/GLOB/CINT:` split-direction for the note; same template as Anthropic enterprise pricing piece. Note clipping practice: the cost-input-only headline may appear under IT Services tagged `GLOB/CINT:` — promote to the split-direction note only when the governance-vs-input-cost tension is the actual hook.
