...
# Source: Obsidian wiki vault (NEWS_WRITER_CONTEXT.md, latam-tmt-coverage-universe.md, — auto-updated 2026-05-11 — auto-updated 2026-05-14 — auto-updated 2026-05-19 — auto-updated 2026-05-21 — auto-updated 2026-05-22 — auto-updated 2026-05-25
...
- **Spectrum / regulator agendas** — MX CRT 5G industrial auction consultation (May-26 opening flagged in E), Colombia ANE 2026–2030 plan, BZ 700 MHz auction (TRF-3 / Telcomp liminar reversal, regional ISP exclusion, leilão dates — per E 30-Apr, "Anatel confirma abertura das propostas do 700 MHz para dia 4" is the imminent trigger; promote to full note on auction day).
- **TelevisaUnivision capital structure** — tender offer for 8.000% Senior Secured Notes due 2028 (E, 8-Apr). TV has 8 Observer notes per H; treat capital-structure events (refis, tender offers, debt covenants) as promotion triggers, not just earnings.
...
- **Hyperscaler / enterprise coding-agent cost surge** — Microsoft, Uber and other enterprise AI-tool customers disclosing unexpected token bills (per B note "Microsoft and Uber reportedly hit by unexpected coding-agent cost surge in 2026"). Tag `TOTVS/GLOB/CINT:` split-direction; same template as Anthropic enterprise pricing piece.
...
| Mexico CRT / Altán / OMV licensing / Padrón de Telefonía / Altán biometric simplification | AMX (always); TIGO if OXIO-related |
...
| TelevisaUnivision capital structure / tender offers / debt refis | TV |
...
- Do not let "AI", "Regulatory", "MX", "BR", "CO", "ANTHROPIC", "EPAM", "ACN" become ticker tags. They are themes/peers — re-tag to the covered name that actually wears the read.
